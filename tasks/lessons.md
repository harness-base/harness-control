...
## 2026-07-07：讲 hc-test 状态时把"跑不跑"埋在"脚本线/回归线占位"里，用户得反问才对上
...
## 2026-07-07：日常汇报里用了圈内黑话"消歧"，用户没听过要专门问，反而拖累沟通
...
## 2026-07-03：把"写测试脚本"和"执行测试"糊成一个流程，用户纠正：产出与执行是两个流程
...
## 2026-07-03：把改 bug 的"复现"写成与"读代码"并列的可选路径，用户纠正：复现是根因的验证器、必须闭环
...
## 2026-07-03：把用户的"纠正某个点"当成"全案批准"，没等说完就全建了
...
## 2026-07-03：排"下一步"按"哪个前置刚通"而不是按开发流程顺序，被纠正（coding 在测试脚本前）
...
## 2026-07-03：又推荐"实战走一遍"当下一步，用户第二次拉回"先把流程建完"
